...
icono = pygame.image.load("espacio-exterior.png")
pygame.display.set_icon(icono)
fondo = pygame.image.load("beautiful-shining-stars-night-sky.jpg")
...
game_over = pygame.image.load("Proyecto nuevo.png")
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if evento.key == pygame.K_SPACE:
                mixer.Sound('disparo.mp3').play().set_volume(0.2)
                nueva_bala = {
                    "x": jugador_x,
                    "y": jugador_y,
                    "velocidad": -2
    ...
    # Mantener dentro de bordes
        ...
        for bala in balas:
            ...
            if colision_bala_enemigo:
                mixer.Sound("Golpe.mp3").play().set_volume(0.2)
                balas.remove(bala)
                puntaje += 1
